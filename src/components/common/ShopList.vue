...
<style lang="scss" scoped>
	...
	.shop_img{
		@include width-height(2.7rem, 2.7rem);
		display: block;
		margin-right: 0.4rem;
	}
	.list_back_li{
	...
	.shop_right{
		...
		.shop_detail_header{
			...
			.shop_detail_ul{
				...
				margin-right: -0.3rem;
				.supports{
					@include font-size-color(0.5rem, #999);
		...
		.rating_order_num{
			...
			.rating_order_num_left{
				...
				.rating_section{
					display: flex;
					.rating_num{
						@include font-size-color(0.4rem, #ff6000);
						margin: 0 0.2rem;
					}
				}
				.order_section{
					transform: scale(.8);
					margin-left: -0.2rem;
					@include font-size-color(0.4rem, #666);
				}
			}
		...
		.fee_distance{
			margin-top: 0.52rem;
			@include fj;
			@include font-size-color(0.5rem, #333);
			.fee{
				transform: scale(.9);
				@include font-size-color(0.5rem, #666);
			}
			.distance_time{
				transform: scale(.9);
				span{
