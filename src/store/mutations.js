/**Store Mutations状态更新属性
 * 
 * @description 将 mutations 封装成单文件的形式, 以便后期
...
export default {
	...
	[ADD_CART](state, {shopid, category_id, item_id, food_id, name, price, specs, packing_fee, sku_id, stock}){
		...
		setStore('buyCart', state.cartList);    // 存入localStorage
	},
	// 3.移出购物车
